...
exports.resetPasswordMsgSuccess = exports.forgotPasswordMessage = exports.verifyEmailMessage = exports.successRegister = void 0;
const successRegister = (password, isGoogle) => {
    return `
    <!DOCTYPE html>
<html>
<head>
                ...
                <table width="600" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 40px 30px; border-radius: 5px;">
                            ...
                            <a href="http://localhost:5000/api/v1/auths/verify-email/${token}" style="font-size: 24px; font-weight: bold; color: #333;">Verifikasi Email</a>
                ...
                <table width="600" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 40px 30px; border-radius: 5px;">
                            ...
                            <p>
                                <a href="http://localhost:5000/api/v1/auths/reset-password/${passwordResetToken}" style="background-color: #007BFF; color: #ffffff; text-align: center; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Reset Kata Sandi</a>
                            </p>
...
exports.resetPasswordMsgSuccess = resetPasswordMsgSuccess;
